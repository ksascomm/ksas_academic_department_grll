	...
	<header>
		<h2 itemprop="headline">
			...
			<?php if ( get_post_meta( $post->ID, 'ecpt_external_link', true ) ) : ?>
				<a href="<?php echo esc_url( get_post_meta( $post->ID, 'ecpt_external_link', true ) ); ?>" target="_blank" title="<?php the_title(); ?>" id="post-<?php the_ID(); ?>" class="archive-post external-link"><?php the_title(); ?> <span class="icon-new-tab2" aria-hidden="true"></span>
				</a>
			<?php else : ?>
